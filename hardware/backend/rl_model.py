...
def build_dqn_architecture() -> tf.keras.Model:
    """
    Reconstruct the exact DQN architecture generated by ai_core/dqn_agent.py.
    """
    model = tf.keras.Sequential([
        tf.keras.layers.Input(shape=(STATE_SIZE,), name="usv_input"),
        tf.keras.layers.Dense(64, activation='relu', name="hidden_1"),
        tf.keras.layers.Dense(64, activation='relu', name="hidden_2"),
        tf.keras.layers.Dense(ACTION_SIZE, activation='linear', name="output_layer")
    ], name="dqn_inference")
    return model
