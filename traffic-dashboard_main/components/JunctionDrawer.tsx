      ...
      {isOpen && (
        ...
        >
          <div className="p-6 space-y-8">
            {/* Sticky Header */}
            <div className="flex items-center justify-between border-b border-slate-200/60 pb-4 -mx-6 px-6 pt-6 -mt-6 sticky top-0 bg-white/80 backdrop-blur-xl z-50">
              <div>
                <motion.h2 
                ...
                >
                  ...
                  <span className="font-medium font-mono uppercase tracking-wider text-xs">SUMO Node: {junctionId}</span>
                </motion.div>
              </div>
              <button
                onClick={onClose}
                className="p-2 bg-slate-100 hover:bg-red-100 rounded-full transition-colors text-slate-600 hover:text-red-600 shadow-sm shrink-0"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
