    ...
    <AnimatePresence initial={false}>
      {isOpen && (
        <motion.div
          ...
          className="w-16 lg:w-64 h-full bg-slate-50/80 backdrop-blur-xl border-r border-slate-200/60 flex flex-col items-center lg:items-start z-40 fixed left-0 top-0 pt-16 shadow-[4px_0_24px_rgba(0,0,0,0.02)]"
        >
