...
export function Topbar() {
  ...
  return (
    <div className="h-16 w-full bg-white border-b border-slate-200 fixed top-0 left-0 z-50 flex items-center justify-between px-4 sm:px-6 shadow-sm">
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        <div className="hidden md:flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-full px-3 py-1">
          ...
          <div className="flex items-center gap-1">
             <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)] animate-pulse" title="Agent 1"></div>
             <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)] animate-pulse" title="Agent 2"></div>
             <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)] animate-pulse" title="Agent 3"></div>
             <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)] animate-pulse" title="Agent 4"></div>
          </div>
        </div>
